...
public class FracCalcul {
    ...
    public static String calculateBoth (String operand2, String operand, String operator){
    	...
    	int [] parsedOne = FracCalcul.parse(operand);
    	...
    	int [] parsedTwo = FracCalcul.parse(operand2);
    	...
    	String calculateAnswer = FracCalcul.Calculate(numeratorOne, denominatorOne, wholeNumberOne, numeratorTwo, denominatorTwo, wholeNumberTwo, operator);
